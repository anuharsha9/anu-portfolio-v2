...
export default function SystemArchaeology({ isLightBackground = true }: SystemArchaeologyProps) {
  ...
  return (
    ...
    >
      ...
      {/* THE INSIGHT FOOTER: Dark Mode System Insight */}
