...
const evolutionStages = [
  {
    ...
    image: '/images/case-study/iq-plugin/Early concept.png',
  },
  {
    id: '02',
    label: 'PHASE_02',
    title: 'Iteration 8',
    description: 'Navigation refinements, card-based layout',
    image: '/images/case-study/iq-plugin/Iteration 8.png',
  },
  {
    id: '03',
    label: 'PHASE_03',
    title: 'Iteration 12',
    description: 'Discover page with tutorials and documentation',
    image: '/images/case-study/iq-plugin/Iteration 12.png',
  },
  {
    id: '04',
    label: 'FINAL',
    title: 'Production Design',
    description: 'Final navigation tiles with unified patterns',
