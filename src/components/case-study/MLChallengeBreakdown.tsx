      ...
      <div className="space-y-3">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-2.5">
          {challenges.map((challenge, index) => (
            <div
              key={index}
              className={`${isLightBackground ? 'bg-white' : 'bg-black/10'} rounded-2xl border-2 p-3 md:p-4 transition-all duration-300 hover:-translate-y-1 hover:shadow-[0_8px_16px_rgba(0,162,183,0.075)]`}
