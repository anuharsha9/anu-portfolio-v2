      ...
      <div className="max-w-[900px] mx-auto px-4 md:px-8 lg:px-12">
        ...
        >
          ...
          <div className="text-slate-600 text-base leading-relaxed space-y-4 mb-8">
            <p>
              I joined this team and quickly realized I was out of my depth. My only option was <strong className="text-slate-900">radical curiosity</strong>—talking to everyone, learning obsessively, earning trust through understanding.
            </p>
            <p>
              My Director of Design became my anchor. He taught me to lead, to present, to believe in myself. He took raw potential and polished it. He called me a <strong className="text-slate-900">UX Leader</strong> before I could call myself one. Today, I mentor others because he mentored me.
            </p>
          </div>
