        ...
        >
          ...
          <div className="flex flex-wrap items-center justify-center gap-4 md:flex-nowrap">
            <a
              ...
              className={`inline-flex items-center gap-2 px-5 py-2.5 rounded-full border ${t.borderSecondary} ${t.textSecondary} font-medium text-sm hover:bg-slate-100 hover:border-slate-400 transition-all duration-300`}
            >
