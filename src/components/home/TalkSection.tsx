        ...
        >
          ...
          <div className="flex flex-col md:flex-row items-center justify-center gap-6 md:gap-10">
            ...
            <a
              ...
              className="text-slate-900 font-mono text-lg md:text-xl hover:text-[var(--accent-teal)] transition-colors duration-300 group"
            >
              <span className="border-b border-slate-300 group-hover:border-[var(--accent-teal)] transition-colors duration-300 pb-1">
          ...
          <div className="flex flex-wrap items-center justify-center gap-4">
            <a
              ...
              className="inline-flex items-center gap-2 px-5 py-2.5 rounded-full border border-slate-300 text-slate-700 font-medium text-sm hover:bg-slate-100 hover:border-slate-400 transition-all duration-300"
            >
