        ...
        >
          ...
          <div className="space-y-6 text-[var(--text-muted-light)] text-base md:text-lg leading-relaxed max-w-4xl mx-auto">
            <p>
              ...
              {' '}is a highly-scalable, enterprise analytics platform with over 45 years of experience—powering self-service analytics, enterprise reporting, and AI-powered insights for hundreds of global organizations. The platform serves millions of concurrent users and processes millions of automated schedules every week.
            </p>
