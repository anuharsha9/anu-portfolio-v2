  ...
  return (
    <div className={`flex items-center gap-3 ${className}`} style={{ display: 'flex', visibility: 'visible', opacity: 1 }}>
      ...
      <div className="flex items-center gap-2">
        ...
        >
          <svg aria-hidden="true" className="w-5 h-5" fill="currentColor" viewBox="0 0 24 24" aria-hidden="true">
        ...
        >
          {copied ? (
            <svg aria-hidden="true" className="w-5 h-5" fill="none" stroke="currentColor" viewBox="0 0 24 24" aria-hidden="true">
