...
export const GEAR_INSPECTOR: Record<string, GearInspectorItem> = {
  "gear-scattered-workflows": {
    ...
    insight: "Transformed a 12-step ML process into a guided 4-step wizard. Zero dead-end errors.",
  ...
  "gear-missing-briefs": {
    ...
    insight: "Took an MIT course, interviewed 50+ stakeholders, and reverse-engineered an ML system I knew nothing about.",
